...
public class ProductDao {
	...
	public void addProduct(Product product) {
		...
		try {
			...
			pst.setInt(1, product.getProdId());
			pst.setString(2, product.getProdName());
			pst.setInt(3, product.getProdPrice());
	...
	public void updateProduct(Product product) {
		...
		try {
			...
			pst.setInt(2, product.getProdPrice());
			pst.setInt(3, product.getProdId());
			int result = pst.executeUpdate();
			if(result==0) {
				System.out.println("The product with given id does not exist");
			}else {
